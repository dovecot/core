...
enum mail_search_mime_arg_type {
	...
	/* text */
	SEARCH_MIME_LINES_EQUAL,
	SEARCH_MIME_LINES_MORE,
	SEARCH_MIME_LINES_FEWER,
...
struct mail_search_mime_arg {
	...
	bool match_always:1; /* result = 1 always */ // FIXME: still needed?
	bool nonmatch_always:1; /* result = 0 always */ // FIXME: still needed?
