...
*/
/*
static void cmd_doveapi_ping(struct doveadm_cmd_context *cctx)
{
...
/*
struct doveadm_cmd_ver2 r7_test1 = { .name = "r7test1",
                                     .cmd = cmd_test1,
